...
unsigned int frame;
GameLogic game;
float C[] = {30,30,30,0};		// Light location
...
void drawWorld() {	
	...
	//TODO: Project above objects to the XZ Plane from light point (C)
	//TODO: Use stencil buffer to draw floor with Ambient light only
...
void init() {
	...
	glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, 22);
}
...
void display(void) {	
	...
	//TODO: Use the stencil buffer to mask the shape of the mirror
	//TODO: Draw flipped world
	//TODO: Render Actor in flipped world (drawActor())
